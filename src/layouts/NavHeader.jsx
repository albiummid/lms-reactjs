      ...
      >
        ...
        {type === 'merchant' && isForm && (
          ...
          >
            ...
            <Link style={{ color: '#616161' }} href='/about-us'>
              <p style={{ color: '#616161' }} className='font-medium text-base'>
                About Us
              </p>
            </Link>
            <Link style={{ color: '#616161' }} href='/'>
              <p style={{ color: '#616161' }} className='font-medium text-base'>
                Benefits
              </p>
            </Link>
        ...
        <div className='hidden lg:flex items-center space-x-6 '>
          ...
          {!isAuth ? (
            <React.Fragment>
              <Link href={type === 'merchant' ? '/merchant/login' : '/login'}>
